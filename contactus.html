	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="index.html"><img src="thrilltaker.png" style="width:60px; alt="
									company logo here"></a></strong>
		...
		*************************************-->
		<section class="tg-parallax tg-innerbanner" data-appear-top-offset="600" data-parallax="scroll"
			data-image-src="images/index/banner4.jpg">
		...
		*************************************-->
		...
		<div class="container">
			<div class=" clearfix">
				<div class=" mb-3 mt-5"
					style=" padding:10px; border-radius:0.25px;margin:auto; width:550px;">
					

					<h2 class="text-center mt-4">Tour and Travel Booking Form</h2>
					<form  action="" method="POST">
						<div class="form-group">
							...
							<input type="date" name=traveldate class="form-control" id="date">
						</div>
						...
						<div id="tg-content" class="tg-content">
							<ul class="tg-contactinfo">
								...
								<li>
									...
									<address>Manhatta Hall Veerpolder 7 2361 Empor Ltd 1258, Melbourne, Australia
									</address>
