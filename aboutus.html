	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="index.html"><img src="thrilltaker.png"style="width:60px; alt="company logo here"></a></strong>
						...
						<nav id="tg-nav" class="tg-nav">
							...
							<ul>
									...
									<li class="menu-item-has-children  current-menu-item"><a href="aboutus.php">about us</a></li>
		...
		*************************************-->
		<!--************************************
				Inner Banner Start
		*************************************-->
		<section class="tg-parallax tg-innerbanner" data-appear-top-offset="600" data-parallax="scroll" data-image-src="images/index/wallpaper5.jpg">
		...
		*************************************-->
		<main id="tg-main" class="tg-main tg-haslayout">
			...
			*************************************-->
			<section class="tg-parallax" data-appear-top-offset="600" data-parallax="scroll" data-image-src="images/index/banner5.jpg">
				<div class="tg-sectionspace tg-haslayout">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div id="tg-guidesslider" class="tg-guidesslider tg-guides owl-carousel">
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="images/index/guide1.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											<h3><a href="javascript:void(0);">Ravi Prakash</a></h3>
								...
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="images/index/guide2.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											<h3><a href="javascript:void(0);">Allu Arjun</a></h3>
											<h4><a href="javascript:void(0);">Adventure Master</a></h4>
											<ul class="tg-socialicons">
												<li><a href="javascript:void(0);"><img src="images/icons/icon-05.png" alt="image destinations"></a></li>
												<li><a href="javascript:void(0);"><img src="images/icons/icon-06.png" alt="image destinations"></a></li>
								...
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="images/index/guide3.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											<h3><a href="javascript:void(0);">Deepak Sharma</a></h3>
											<h4><a href="javascript:void(0);">Adventure Master</a></h4>
											<ul class="tg-socialicons">
												<li><a href="javascript:void(0);"><img src="images/icons/icon-05.png" alt="image destinations"></a></li>
												<li><a href="javascript:void(0);"><img src="images/icons/icon-06.png" alt="image destinations"></a></li>
								...
								<div class="item tg-guide">
									<figure><a href="javascript:void(0);"><img src="images/index/guide4.jpg" alt="image destination"></a></figure>
									<div class="tg-guidecontent">
										<div class="tg-guidecontenthead">
											<h3><a href="javascript:void(0);">Irfan Pathan</a></h3>
											<h4><a href="javascript:void(0);">Adventure Master</a></h4>
											<ul class="tg-socialicons">
												<li><a href="javascript:void(0);"><img src="images/icons/icon-05.png" alt="image destinations"></a></li>
												<li><a href="javascript:void(0);"><img src="images/icons/icon-06.png" alt="image destinations"></a></li>
			...
			*************************************-->
			<section class="tg-aboutus">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="row">
						<figure data-vide-bg="poster: images/index/about1.jpg" data-vide-options="position: 0% 50%"></figure>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 pull-right">
					<div class="row">
						<figure data-vide-bg="poster: images/index/about2.jpg" data-vide-options="position: 0% 50%"></figure>
					</div>
				</div>
			...
			*************************************-->
			<!--************************************
					Our Partners Start
			*************************************-->
			<section class="tg-parallax" data-appear-top-offset="600" data-parallax="scroll" data-image-src="images/index/banner6.jpg">
				<div class="tg-sectionspace tg-haslayout">
					<div class="container">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
